...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">당근마켓</h3>
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid border-b grid-cols-2 gap-16 mt-8 w-full">
            <button
              ...
              className={cls("pb-4 font-medium", method === "email" ? 
                "text-orange-400 border-b border-orange-500" : "border-transparent text-gray-300"
              )}
            >이메일</button>
            <button 
              onClick={onPhoneClick}
              className={cls("pb-4 font-medium", method === "phone" ? 
              "text-orange-400 border-b border-orange-500" : "border-transparent text-gray-300"
              )}
            >전화번호</button>
          </div>
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative -top-3 text-center">
              <span className="bg-white px-2 text-sm text-gray-500 select-none">또는</span>
            </div>
          </div>
